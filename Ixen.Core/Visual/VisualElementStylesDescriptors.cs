...
namespace Ixen.Core.Visual
{
    public class VisualElementStylesDescriptors
    {
        ...
        public ObjectPositionStyleDescriptor ObjectPosition { get; set; } = new();
        ...
        public LetterSpacingStyleDescriptor LetterSpacing { get; set; } = new();
        ...
        public MinHeightStyleDescriptor MinHeight { get; set; } = new();
        public MinWidthStyleDescriptor MinWidth { get; set; } = new();
