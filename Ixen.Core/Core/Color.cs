...
namespace Ixen.Core
{
    public readonly struct Color
    {
        ...
        public static readonly Color Aqua                 = new Color(0x0, 0xFF, 0xFF);
        ...
        public static readonly Color Black                = new Color(0x0, 0x0, 0x0);
        public static readonly Color BlanchedAlmond       = new Color(0xFF, 0xFF, 0xCD);
        public static readonly Color Blue                 = new Color(0x0, 0x0, 0xFF);
        ...
        public static readonly Color Chartreuse           = new Color(0x7F, 0xFF, 0x0);
        ...
        public static readonly Color Cyan                 = new Color(0x0, 0xFF, 0xFF);
        public static readonly Color DarkBlue             = new Color(0x0, 0x0, 0x8B);
        public static readonly Color DarkCyan             = new Color(0x0, 0x8B, 0x8B);
        public static readonly Color DarkGoldenrod        = new Color(0xB8, 0x86, 0xB);
        public static readonly Color DarkGray             = new Color(0xA9, 0xA9, 0xA9);
        public static readonly Color DarkGreen            = new Color(0x0, 0x64, 0x0);
        public static readonly Color DarkKhaki            = new Color(0xBD, 0xB7, 0x6B);
        public static readonly Color DarkMagena           = new Color(0x8B, 0x0, 0x8B);
        public static readonly Color DarkOliveGreen       = new Color(0x55, 0x6B, 0x2F);
        public static readonly Color DarkOrange           = new Color(0xFF, 0x8C, 0x0);
        public static readonly Color DarkOrchid           = new Color(0x99, 0x32, 0xCC);
        public static readonly Color DarkRed              = new Color(0x8B, 0x0, 0x0);
        ...
        public static readonly Color DarkSlateGray        = new Color(0x28, 0x4F, 0x4F);
        public static readonly Color DarkTurquoise        = new Color(0x0, 0xCE, 0xD1);
        public static readonly Color DarkViolet           = new Color(0x94, 0x0, 0xD3);
        public static readonly Color DeepPink             = new Color(0xFF, 0x14, 0x93);
        public static readonly Color DeepSkyBlue          = new Color(0x0, 0xBF, 0xFF);
        ...
        public static readonly Color Fuschia              = new Color(0xFF, 0x0, 0xFF);
        ...
        public static readonly Color Gold                 = new Color(0xFF, 0xD7, 0x0);
        ...
        public static readonly Color Green                = new Color(0x0, 0x80, 0x0);
        ...
        public static readonly Color Indigo               = new Color(0x4B, 0x0, 0x82);
        public static readonly Color Ivory                = new Color(0xFF, 0xF0, 0xF0);
        ...
        public static readonly Color LawnGreen            = new Color(0x7C, 0xFC, 0x0);
        ...
        public static readonly Color Lime                 = new Color(0x0, 0xFF, 0x0);
        ...
        public static readonly Color Magenta              = new Color(0xFF, 0x0, 0xFF);
        public static readonly Color Maroon               = new Color(0x80, 0x0, 0x0);
        public static readonly Color MediumAquamarine     = new Color(0x66, 0xCD, 0xAA);
        public static readonly Color MediumBlue           = new Color(0x0, 0x0, 0xCD);
        ...
        public static readonly Color MediumSpringGreen    = new Color(0x0, 0xFA, 0x9A);
        public static readonly Color MediumTurquoise      = new Color(0x48, 0xD1, 0xCC);
        public static readonly Color MediumVioletRed      = new Color(0xC7, 0x15, 0x70);
        ...
        public static readonly Color Navy                 = new Color(0x0, 0x0, 0x80);
        public static readonly Color OldLace              = new Color(0xFD, 0xF5, 0xE6);
        public static readonly Color Olive                = new Color(0x80, 0x80, 0x0);
        public static readonly Color OliveDrab            = new Color(0x6B, 0x8E, 0x2D);
        public static readonly Color Orange               = new Color(0xFF, 0xA5, 0x0);
        public static readonly Color OrangeRed            = new Color(0xFF, 0x45, 0x0);
        ...
        public static readonly Color PeachPuff            = new Color(0xFF, 0xDA, 0x9B);
        ...
        public static readonly Color Purple               = new Color(0x80, 0x0, 0x80);
        public static readonly Color Red                  = new Color(0xFF, 0x0, 0x0);
        ...
        public static readonly Color SpringGreen          = new Color(0x0, 0xFF, 0x7F);
        public static readonly Color SteelBlue            = new Color(0x46, 0x82, 0xB4);
        public static readonly Color Tan                  = new Color(0xD2, 0xB4, 0x8C);
        public static readonly Color Teal                 = new Color(0x0, 0x80, 0x80);
        public static readonly Color Thistle              = new Color(0xD8, 0xBF, 0xD8);
        public static readonly Color Tomato               = new Color(0xFD, 0x63, 0x47);
        ...
        public static readonly Color Yellow               = new Color(0xFF, 0xFF, 0x0);
