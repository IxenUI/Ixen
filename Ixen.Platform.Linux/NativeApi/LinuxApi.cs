...
namespace Ixen.Platform.Linux.NativeApi
{
    internal static class LinuxApi
    {
        ...
        public delegate void OnKeyCallBack(int kind, int keySymbol, int modifiers, int repeat);
        ...
        [DllImport(LIB_NAME, EntryPoint = "WA_CloseWindow", CallingConvention = CallingConvention.Cdecl)]
        public static extern void CloseWindow(IntPtr windowPtr);
        ...
        public static extern void SetWindowCursorImage(IntPtr windowPtr, byte[] pixels, int width, int height, int hotspotX, int hotspotY);
        ...
        [DllImport(LIB_NAME, EntryPoint = "WA_RegisterTextCallBack", CallingConvention = CallingConvention.Cdecl)]
        public static extern void RegisterTextCallBack(IntPtr windowPtr, [MarshalAs(UnmanagedType.FunctionPtr)] OnTextCallBack callback);
        ...
        public static extern IntPtr GetClipboardText(IntPtr windowPtr);
        ...
        public static extern void Cancel(long identifier);
